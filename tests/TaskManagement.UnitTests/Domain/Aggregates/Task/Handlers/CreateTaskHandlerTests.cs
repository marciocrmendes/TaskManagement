...
public class CreateTaskHandlerTests
{
    ...
    public async System.Threading.Tasks.Task Handle_WhenProjectExists_AndNotAtTaskLimit_ShouldCreateTask()
    {
        ...
        _taskRepositoryMock
            .Setup(repo => repo.AddAsync(It.IsAny<TaskManagement.Domain.Entities.Task>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((TaskManagement.Domain.Entities.Task task, CancellationToken _) => 
            {
    ...
    public async System.Threading.Tasks.Task Handle_WhenProjectDoesNotExist_ShouldReturnDefaultAndAddNotification()
    {
        ...
        _taskRepositoryMock.Verify(repo => 
            repo.AddAsync(It.IsAny<TaskManagement.Domain.Entities.Task>(), It.IsAny<CancellationToken>()), Times.Never);
    }
